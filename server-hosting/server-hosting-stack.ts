...
export class ServerHostingStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const server = new ec2.Instance(this, `${prefix}Server`, {
      ...
      instanceType: new ec2.InstanceType("m7i-flex.largge")
      ...
      machineImage: ec2.MachineImage.fromSsmParameter("/aws/service/canonical/ubuntu/server/22.04/stable/current/amd64/hvm/ebs-gp2/ami-id"),
